...
export function MaxTool({ project, animal, ...props }) {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-md font-bold text-sm">Max Projection</h1>
      </div>
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4 sm:p-6">
          <DialogPanel className="max-w-lg space-y-4 border bg-white p-12 rounded-sm transition-all w-full duration-300">
            ...
            <p className="text-black text-sm">
              Max projection lets you quickly max project tiff images with a
              single signal channel and a z-stack of focal plane images.
            </p>
            <div>
