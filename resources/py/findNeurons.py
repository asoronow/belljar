...
parser.add_argument('-c', '--confidence', help="confidence level for detections", default=0.50)
parser.add_argument('-m', '--model', help="specify model file", default='../models/ancientwizard.pt')
